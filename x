...
local function LWUTX_fake_script() -- R6.LocalScript 
...
coroutine.wrap(LWUTX_fake_script)()
local function JYBZQIO_fake_script() -- nil.Script 
...
coroutine.wrap(JYBZQIO_fake_script)()
local function HSUBNN_fake_script() -- Exe.LocalScript 
...
coroutine.wrap(HSUBNN_fake_script)()
local function ZUMEGPK_fake_script() -- Exe.Script 
...
coroutine.wrap(ZUMEGPK_fake_script)()
local function JDUEGK_fake_script() -- Cle.LocalScript 
...
coroutine.wrap(JDUEGK_fake_script)()
local function ZOODYKE_fake_script() -- main.Main Script 
...
coroutine.wrap(ZOODYKE_fake_script)()
local function ZIWGF_fake_script() -- main.Drag 
	local script = Instance.new('LocalScript', main)
	local req = require
	local require = function(obj)
		local fake = fake_module_scripts[obj]
...
coroutine.wrap(ZIWGF_fake_script)()
